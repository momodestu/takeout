...
CREATE TABLE `address_book` (
  ...
  `province_code` varchar(12) CHARACTER SET utf8 DEFAULT NULL COMMENT '省级区划编号',
  `province_name` varchar(32) CHARACTER SET utf8 DEFAULT NULL COMMENT '省级名称',
  `city_code` varchar(12) CHARACTER SET utf8 DEFAULT NULL COMMENT '市级区划编号',
  `city_name` varchar(32) CHARACTER SET utf8 DEFAULT NULL COMMENT '市级名称',
  `district_code` varchar(12) CHARACTER SET utf8 DEFAULT NULL COMMENT '区级区划编号',
  `district_name` varchar(32) CHARACTER SET utf8 DEFAULT NULL COMMENT '区级名称',
  `detail` varchar(200) CHARACTER SET utf8 DEFAULT NULL COMMENT '详细地址',
  `label` varchar(100) CHARACTER SET utf8 DEFAULT NULL COMMENT '标签',
  `is_default` tinyint(1) NOT NULL DEFAULT '0' COMMENT '默认 0 否 1是',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='地址簿';
...
INSERT INTO `address_book` VALUES ('4', '5', '好的撒', '0', '13892019234', '11', '北京市', '1101', '市辖区', '110102', '西城区', '的撒', '1', '1');
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='菜品及套餐分类';
...
) ENGINE=InnoDB AUTO_INCREMENT=83 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='菜品';
...
CREATE TABLE `dish_flavor` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=110 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='菜品口味关系表';
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='员工信息';
...
CREATE TABLE `operation_log` (
  ...
  `url` varchar(100) NOT NULL COMMENT '记录的url',
  `port_check` int(11) NOT NULL COMMENT '1是后端，2是前端',
  `ip` varchar(40) NOT NULL,
  `method` varchar(30) NOT NULL,
  `exception_detected` varchar(30) DEFAULT NULL,
  `args` varchar(30) DEFAULT NULL,
  `user_id` int(11) NOT NULL,
  `update_time` datetime NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='操作日志记录';
...
INSERT INTO `orders` VALUES ('1721037700786', '1721037700786', '6', '5', '4', '2024-07-15 18:01:41', null, '1', '0', '126.00', '', '13892019234', '的撒', null, '好的撒', '支付超时，自动取消', null, '2024-07-15 18:22:00', '2024-07-15 19:01:00', '0', null, '1', '0', '0');
INSERT INTO `orders` VALUES ('1721039085413', '1721039085413', '6', '5', '4', '2024-07-15 18:24:45', null, '1', '0', '75.00', '', '13892019234', '的撒', null, '好的撒', '支付超时，自动取消', null, '2024-07-15 18:40:00', '2024-07-15 19:24:00', '0', null, '1', '0', '0');
...
CREATE TABLE `order_detail` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='订单明细表';
...
INSERT INTO `order_detail` VALUES ('18', '江团鱼2斤', 'https://sky-itcast.oss-cn-beijing.aliyuncs.com/a101a1e9-8f8b-47b2-afa4-1abd47ea0a87.png', '1721037700786', '66', null, null, '1', '119.00');
INSERT INTO `order_detail` VALUES ('19', '草鱼2斤', 'https://sky-itcast.oss-cn-beijing.aliyuncs.com/b544d3ba-a1ae-4d20-a860-81cb5dec9e03.png', '1721039085413', '65', null, null, '1', '68.00');
...
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='套餐';
...
CREATE TABLE `setmeal_dish` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='套餐菜品关系';
...
CREATE TABLE `shopping_cart` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='购物车';
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='用户信息';

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('4', 'oZu-74q04FHI3d6L0Cl8EssR7z_Y', null, null, null, null, null, '2023-04-23 16:01:23');
INSERT INTO `user` VALUES ('5', 'oA-2T66xt-3YGlkSPexFGR8n2QMY', null, null, null, null, null, '2024-07-15 17:58:44');
